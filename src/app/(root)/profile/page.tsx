...
const Page = () => {
  ...
  return (
    <div className="font-raleway font-semibold  flex flex-col">
      <div className="absolute bg-hero-pattern  bg-cover h-52 w-screen -z-40  "></div>
      ...
      <div className="relative top-64 left-96  rounded-xl  w-9/12 h-max py-6 flex justify-between bg-red-200">
        <div className="w-full h-full flex flex-col">
          <h1 className="font-semibold text-2xl mb-4 self-center">Skills</h1>
        ...
        <div className="w-full h-full flex flex-col">
          <h1 className="font-semibold text-2xl mb-4 self-center">Interest</h1>
      ...
      <div className="bg-gray-700 w-[93%] left-4 self-center h-96  rounded-2xl relative top-72">
        <div className="-top-4 absolute bg-black -z-10 w-full h-96  rounded-3xl  "></div>
        <div className="flex gap-3 text-3xl relative left-10 top-6 text-white">
          <h1>Project</h1>
          <h1>Events</h1>
          <h1>Achievements</h1>
        </div>
